...
- This script has incorporated all calc_<interaction> files contained in the GitHub repository
  (featuring a few modifications)

    https://github.com/CRPropa/CRPropa3-data

  thus credit goes to the authors of the respective code writers.
- NOTE: spectrum_<fieldName>.txt for ~/share/crpropa/ElectronPairProduction can NOT be 
  ...
  *very* close to zero, a copy of spectrum_CMB.txt could be used.
...
Arguments:
  ...
  <toDirectory>     path/to/share/crpropa/
...
class photonField:
    ...
    def __init__(self, fromFile, photonFieldName):
        ...
        self.data = self.read_photonField(fromFile)
        self.redshift
...
class Interactions:
    ...
    def calc_electromagnetic(fields, writeFilesTo):
        ...
        def getEmin(sigma, field):
            ...
            return getSmin(sigma) / 4 / field.getEpsMax()
        ...
        def process(sigma, field, name):
            ...
            skin2 = 4 * field.getEpsMin() * E[0]  # minimum achievable s in collision with background photon (at any tabulated E)
    ...
    def calc_pairproduction(fields, writeFilesTo):
        ...
        def lossRate(gamma, field, z=0):
            ...
            epsmin = field.getEpsMin() / me_c2
            epsmax = field.getEpsMax() / me_c2
...
if __name__ == "__main__":
    ...
    arguments = docopt(__doc__, version='02/19')
